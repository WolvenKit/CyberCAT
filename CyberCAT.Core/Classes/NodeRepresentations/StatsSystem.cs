...
namespace CyberCAT.Core.Classes.NodeRepresentations
{
    public class StatsSystem
    {
        ...
        public Dictionary<GameStatsObjectID, GameSavedStatsData> Entries { get; set; }
        private GenericUnknownStruct _genericStruct;
        public StatsSystem(GenericUnknownStruct source)
        {
            _genericStruct = source;
            Entries = new Dictionary<GameStatsObjectID, GameSavedStatsData>();
        }
        public GenericUnknownStruct GetUnknownStruct()
        {
